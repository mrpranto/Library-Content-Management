...
<script src="/api_doc/swagger-ui-bundle.js" charset="UTF-8"></script>
<script src="/api_doc/swagger-ui-standalone-preset.js" charset="UTF-8"></script>
<script>
    window.onload = function () {
        // Begin Swagger UI call region
        const ui = SwaggerUIBundle({
            url        : "/api_doc/swagger.json",
            dom_id     : '#swagger-ui',
            deepLinking: true,
            presets    : [
